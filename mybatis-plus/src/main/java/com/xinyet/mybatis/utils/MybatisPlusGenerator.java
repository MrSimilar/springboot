package com.xinyet.mybatis.utils;
...
//        paths.add("ApplicationHome: " + jarFile.getParent());
        ...
        String moduleName = "/mybatis-plus";
        Properties properties = System.getProperties();
        paths.add("Properties(os.name): " + properties.getProperty("os.name"));
        paths.add("Properties(user.dir): " + properties.getProperty("user.dir") + moduleName + "/src/main/java");
    ...
    public static void main(String[] args) {
        ...
        String dbUrl = "jdbc:mysql://127.0.0.1:3306/mybatis?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true";
        //String driverName = "com.mysql.cj.jdbc.Driver"; // ("com.mysql.jdbc.Driver");
        String dbUsername = "root";
        String dbPassword = "1234567890";

        String projectPath = System.getProperty("user.dir");
        String globalConfigOutputDir = projectPath + moduleName +"/src/main/java";
        String globalConfigAuthor = "via";
        String packageConfigParent = "com.xinyet.mybatis";
